...
import { Loader2, DollarSign, Users, FileCheck, FolderOpen, Brain, Settings, BarChart3, ScrollText, ChevronLeft, HeartPulse, Wrench, Building2 } from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { to: "/admin/facility", label: "Facility", icon: Building2 },
