...
const Footer = () => {
  const footerLinks = {
    training: [
      { name: "Hitting Courses", href: "#" },
      { name: "Pitching Courses", href: "#" },
      { name: "Fielding Courses", href: "#" },
      { name: "Mental Game", href: "#" },
    ],
    company: [
      { name: "About Us", href: "#" },
      { name: "Our Coaches", href: "#" },
      { name: "Careers", href: "#" },
      { name: "Press", href: "#" },
    ],
    support: [
      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground mb-6 max-w-sm">
              Elite baseball training from professional coaches. 
              Transform your game from anywhere in the world.
            </p>
        ...
        <div className="border-t border-border mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-muted-foreground text-sm">
            © 2024 Diamond Baseball. All rights reserved.
          </p>
          <p className="text-muted-foreground text-sm">
            Made for players who want to be great.
          </p>
        </div>
      </div>
    </footer>
