...
export const allCourses = [
  ...
  // 2️⃣ VAULT™ SOFTBALL HITTING SYSTEM
  {
    id: "softball-hitting-complete",
    title: "Softball Hitting System",
    description: "Balance → Load → Explode. Hip-driven swing mechanics, slap hitting mastery, pitch recognition, and game transfer. Built for fastpitch athletes from mechanics to at-bats.",
    image: courseHitting,
    duration: "10 Weeks",
    modules: 7,
    lessons: 42,
    ...
    features: [
      "Stance & balance foundations",
      "Load & timing mechanics",
      "Hip rotation engine",
      "Bat path & contact zones",
      "Slap hitting system (CRITICAL)",
      "Pitch recognition & decision training",
      "Game transfer protocols",
    ],
    instructor: "Vault Performance",
    students: 720,
    isNew: true,
