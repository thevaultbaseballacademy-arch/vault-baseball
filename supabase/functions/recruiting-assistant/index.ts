...
- Name: ${athleteContext.name || "Not provided"}
- Position: ${athleteContext.position || "Not provided"}
- Graduation Year: ${athleteContext.graduationYear || "Not provided"}
- Target Schools: ${athleteContext.targetSchools?.join(", ") || "Not specified"}`;
    }
